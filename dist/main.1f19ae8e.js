...
var step = function step() {
  setTimeout(function () {
    ...
    if (n < string.length - 1) {
      n += 1; // 一个54个字符串，但是下标是从0开始的[n]应该到53就结束了，但是当到53的时候53<string.length，此时还会进行一次循环，会循环出undefined，所以应该改为string.length-1
